...
This project contains fake password-style examples
inspired by Terrible Mouse.

⚠️ These are NOT real passwords.
...
4. These Terrible Mouse password-style examples are only for fun and learning.